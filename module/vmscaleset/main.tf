...
resource "azurerm_linux_virtual_machine_scale_set" "linux_vmss" {
  ...
  admin_password                                    = var.disable_password_authentication == false && var.admin_password == null ? element(concat(module.random-password.password.*.result, [""]), 0) : var.admin_password
